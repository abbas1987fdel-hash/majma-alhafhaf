...
export default defineSchema({
  ...
  settings: defineTable({ name: v.string(), intro: v.string(), logoId: v.optional(v.id('_storage')), salt: v.string(), pinHash: v.string(), authVersion: v.number(), sequence: v.number() }),
